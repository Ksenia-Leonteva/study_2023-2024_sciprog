...
![Рис.6: Построение простейших графиков](image/Pic 7.jpg){ #fig:007 width=70% }
...
![Рис.7: Два графика на одном чертеже](image/Pic 8.jpg){ #fig:008 width=70% }

## Ход выполнения лабораторной работы
- Построили график $y = x^2sin(x)$

![Рис.8: График $y = x^2sin(x)$](image/Pic 9.jpg){ #fig:009 width=80% }
...
![Рис.9: Сравнение двух программ](image/Pic 12.jpg){ #fig:012 width=45% }
